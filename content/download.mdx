...
Downloads are provided via the [MS Annika GitHub repository](https://github.com/hgb-bin-proteomics/MSAnnika).

**Here are the latest release versions of MS Annika:**
