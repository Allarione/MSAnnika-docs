...
## Installation of Proteome Discoverer

- Can be downloaded for free from [here](https://www.thermofisher.com/at/en/home/industrial/mass-spectrometry/liquid-chromatography-mass-spectrometry-lc-ms/lc-ms-software/multi-omics-data-analysis/proteome-discoverer-software.html)
- Requirements of Proteome Discoverer apply

## Installation of MS Annika

- Via the installer available from this website or from the [repository](https://github.com/hgb-bin-proteomics/MSAnnika)
